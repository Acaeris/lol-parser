...
class ChampionRegenResourceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('LeagueOfData\Entity\Champion\ChampionRegenResource');
        $this->shouldImplement('LeagueOfData\Entity\Champion\ChampionRegenResourceInterface');
