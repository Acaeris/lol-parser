...
namespace spec\LeagueOfData\Service\Json\MatchList;
...
class MatchListCollectionSpec extends ObjectBehavior
{
    private $mockData = [
        'gameId' => 1,
        'region' => "euw"
    ...
    {
        $this->shouldHaveType('LeagueOfData\Service\Json\MatchList\MatchListCollection');
