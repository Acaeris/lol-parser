...
use LeagueOfData\Service\Json\Champion\ChampionStatsCollection;
use LeagueOfData\Service\Json\Champion\ChampionSpellCollection;
use LeagueOfData\Service\Json\Champion\ChampionPassiveCollection;
...
class ChampionCollectionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('LeagueOfData\Service\Json\Champion\ChampionCollection');
