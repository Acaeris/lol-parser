...
class ChampionSpellResourceSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('LeagueOfData\Models\Champion\ChampionSpellResource');
        $this->shouldImplement('LeagueOfData\Models\Interfaces\ChampionSpellResourceInterface');
