...
namespace spec\LeagueOfData\Repository\Summoner;
...
class JsonSummonerRepositorySpec extends ObjectBehavior
{
    private $mockData = [
        "id" => 1,
        "accountId" => 2,
    ...
    {
        $this->shouldHaveType('LeagueOfData\Repository\Summoner\JsonSummonerRepository');
