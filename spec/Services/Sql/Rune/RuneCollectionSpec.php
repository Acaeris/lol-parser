<?php
namespace spec\App\Services\Sql\Rune;
...
class RuneCollectionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('App\Services\Sql\Rune\RuneCollection');
    ...
    public function it_can_convert_data_to_rune_objects()
    {
        ...
        $this->create($data)->shouldImplement('App\Models\Rune\RuneInterface');
    }
