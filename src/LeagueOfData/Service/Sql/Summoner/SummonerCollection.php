...
namespace LeagueOfData\Service\Sql\Summoner;
...
class SummonerCollection implements StoreServiceInterface
{
    ...
    public function add(array $summoners)
    {
        foreach ($summoners as $summoner) {
            ...
            $this->logger->error('Incorrect object supplied to Summoner service', [$summoner]);
        }
    }
