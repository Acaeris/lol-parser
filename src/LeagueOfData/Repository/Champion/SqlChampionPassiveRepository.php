...
/**
 * Champion Passive object DB Repository
 *
 * @package LeagueOfData\Repository
 * @author  Caitlyn Osborne <acaeris@gmail.com>
 * @link    http://lod.gg League of Data
 */
class SqlChampionPassiveRepository implements StoreRepositoryInterface
{
    /**
     * @var Connection
     */
    ...
    public function add(array $passives)
    {
        foreach ($passives as $passive) {
            ...
            $this->logger->error('Incorrect object supplied to Champion Passives repository', [$passive]);
        }
    }
