...
/**
 * Champion Spells object DB Repository
 *
 * @package LeagueOfData\Repository
 * @author  Caitlyn Osborne <acaeris@gmail.com>
 * @link    http://lod.gg League of Data
 */
class SqlChampionSpellRepository implements StoreRepositoryInterface
{
    /**
     * @var LoggerInterface
     */
    ...
    public function add(array $spells)
    {
        foreach ($spells as $spell) {
            ...
            $this->logger->error('Incorrect object supplied to Champion Spells repository', [$spell]);
        }
    }
