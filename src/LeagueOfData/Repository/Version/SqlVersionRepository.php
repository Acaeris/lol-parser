...
namespace LeagueOfData\Repository\Version;
...
/**
 * Version object DB Repository.
 *
 * @package LeagueOfData\Repository
 * @author  Caitlyn Osborne <acaeris@gmail.com>
 * @link    http://lod.gg League of Data
 */
class SqlVersionRepository implements StoreRepositoryInterface
{
    /**
    ...
    public function add(array $versions)
    {
        foreach ($versions as $version) {
            ...
            $this->log->error('Incorrect object supplied to Version repository', [$version]);
        }
    }
