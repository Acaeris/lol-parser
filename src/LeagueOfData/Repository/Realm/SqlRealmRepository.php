...
/**
 * Realm object Db repository.
 *
 * @package LeagueOfData\Repository
 * @author  Caitlyn Osborne <acaeris@gmail.com>
 * @link    http://lod.gg League of Data
 */
class SqlRealmRepository implements StoreRepositoryInterface
{
    /**
    ...
    public function add(array $realms)
    {
        foreach ($realms as $realm) {
            ...
            $this->log->error('Incorrect object supplied to Realm repository', [$realm]);
        }
    }
